 ...
 * hero band — text overlaid directly on the image with a gradient, same
 * pattern as every other page's hero — then continues with the rest of
 * the page content unchanged (the quote form stays where it already was,
...
<section class="page-hero">
    ...
    <div class="page-hero__text">
        ...
        <p class="page-hero__services">Turf Cleaning &middot; Installation &middot; Repair</p>
